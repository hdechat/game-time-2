...
class Game {
  constructor(context, canvasHeight, canvasWidth) {
    ...
    this.gameLog1 = new Log(0* 90, 220, 60, 40)
    this.gameLog2 = new Log( 1* 180, 180, 200, 30)
    this.gameLog3 = new Log( 2 *200, 160, 200, 30)
    this.gameLog4 = new Log(3 * 160, 200, 200, 30)
    this.gameLog5 = new Log(4 * 180, 170, 200, 30)
