...
class Game {
    ...
    constructor() {
        ...
        // for (var i = 0; i < 5; i++){
        //     let home = new Home(i * 185 + 75, 50, 110, 50, '#004F00' );
    ...
    gameLoop(context) {
        ...
        console.log(this.home1.status)  
        // this.frogHomeSafe = this.homesArray[2].checkForFrog(this.gameFrog) 
        // this.frogHomeSafe = this.homesArray[3].checkForFrog(this.gameFrog)  
        // this.frogHomeSafe = this.homesArray[4].checkForFrog(this.gameFrog) 
